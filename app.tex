...
\begin{frame}{Geração de imagens artificiais --- Mistura saliente}
  ...
  \begin{figure}
    \begin{center}
      \subfloat[Original]{
      \includegraphics[width=.2\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-a.png}}
      }
      \subfloat[Original]{
      \includegraphics[width=.2\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-b.png}}
      }
      \subfloat[Imagem artificial]{
      \includegraphics[width=.2\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-c.png}}
      }
    \end{center}
...
\begin{frame}{Experimento --- Visualização}
  ...
  \begin{figure}
    ...
    \begin{itemize}
      \item Projeção no plano da base original balanceada;
