...
\begin{frame}{Quantização de imagens}
  \begin{figure}
    ...
    \end{center}
    \caption{Versões de um canal de cor com 232 intensidades únicas para o método (e) MSB e 184 intensidades para os demais métodos. Os métodos \emph{Luminância'} e MSB conseguiram uma melhor discriminação entre cores.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Quantização de imagens}
  \begin{figure}
    ...
    \end{center}
    \caption{Imagens da base \emph{Caltech101-600} com variações no parâmetro de cor utilizando o método MSB.}
  \end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Método}
...
\begin{figure}[!htbp]
  \begin{center}
    \centering
    \includegraphics[width=.8\linewidth]{\detokenize{figuras/quantization/fig_results_individual.png}}
  \end{center}
  \caption{Para cada método de extração de características a acurácia é resultante da sua aplicação utilizando 256, 128, 64, 32, 16 e 8 cores, da esquerda para a direita.}
\end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
  \begin{figure}[!htbp]
    ...
    \end{center}
    \caption{Acurácia média da classificação utilizando MSB considerando 256, 128, 64 e 32 cores com BIC. Os \textit{boxplots} em cinza correspondem às significâncias estatísticas com $\textit{p-value} < 0.01$ quando comparado à acurácia de 256 cores.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
  \begin{figure}[!htbp]
    ...
    \end{center}
    \caption{Acurácia média da classificação após a utilização do método de quantização \emph{Luminância'} considerando 256, 128, 64 e 32 cores com o descritor Haralick.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
  \begin{figure}[!htbp]
    ...
    \end{center}
    \caption{Acurácia para os método MSB (quantização), LPP (redução de dimensionalidade) e BIC (extração de características). A comparação do LPP versus MSB foi realizada com a mesma dimensionalidade.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
  \begin{figure}[!htbp]
    ...
    \end{center}
    \caption{Acurácia de diferentes métodos de quantização: \emph{Gleam}, \emph{Intensidade'}, \emph{Luminância'} e MSB. As imagens foram convertidas para escala de cinza com esses quatro métodos e foram dadas como entrada para todos os métodos de extração. O vetor de características resultante com $D=2310$ sofreu então redução da dimensionalidade com o método LPP para $d = 1160$, $582$, $294$ e $150$.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
...
\begin{frame}{Experimentos}
  \begin{figure}[!htbp]
  \centering
  \includegraphics[scale=.55]{\detokenize{figuras/flow_main.pdf}}
...
\begin{frame}{Experimentos}
  \begin{figure}
  \centering
  \includegraphics[scale=.13]{\detokenize{figuras/folds_chart.png}}
...
\begin{frame}{Experimento}
  \begin{figure}
      \begin{center}
      \subfloat[Desbalanceado]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/desbalanceado-teste-region.png}}
      }
      \subfloat[Smote]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/smote-teste-region.png}}
      }
      \subfloat[Geração artificial]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/geracao-teste-region.png}}
      }
      \end{center}
...
\begin{frame}{Experimento}
  \begin{figure}
      \begin{center}
      \subfloat[Desbalanceado]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/desbalanceado-treino.png}}
      }
      \subfloat[Smote]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/smote-treino.png}}
      }
      \subfloat[Geração artificial]{
        \includegraphics[width=.3\linewidth]{\detokenize{figuras/visualizacao/geracao-treino.png}}
      }
    \end{center}
