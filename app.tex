...
\begin{frame}{Experimentos --- Características de cor}
  ...
  \begin{itemize}
    \item Os \textit{boxplots} em cinza correspondem às significâncias estatísticas com $\textit{p-value} < 0.01$ quando comparado à 256 cores;
    \item Quantizar para 64 cores prova ser boa escolha de processamento.
  \end{itemize}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
...
\begin{frame}{Experimentos --- Concatenação dos vetores}
  ...
  \setlength\leftmargini{1em}
    ...
    \begin{enumerate}
      ...
      \item Extrair as características com todos os métodos;
      \item Concatenar as características em um vetor $D=2310$;
      \item Analisar:
      \begin{itemize}
...
\begin{frame}{Geração de imagens artificiais --- Mistura saliente}
  ...
  \begin{figure}
    \begin{center}
      \subfloat[Original]{
      \includegraphics[width=.31\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-a.png}}
      }
      \subfloat[Original]{
      \includegraphics[width=.31\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-b.png}}
      }
      \subfloat[Imagem artificial]{
      \includegraphics[width=.31\linewidth]{\detokenize{figuras/artificial-generation/methods/saliency-c.png}}
      }
    \end{center}
    \caption{Combinação de saliência.}
    \begin{itemize}
...
\begin{frame}{Experimento --- Visualização}
  ...
  \begin{figure}
    ...
    \begin{itemize}
      \item À direita, as classes após a remoção de 50\% do treino da classe \emph{Horse}.
    \end{itemize}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimento --- Visualização}
  ...
  \begin{figure}
    \begin{center}
      \subfloat[SMOTE]{
      \includegraphics[width=.42\linewidth]{\detokenize{figuras/visualizacao/smote-treino-fixed.png}}
      }
      \subfloat[Geração de imagens]{
      \includegraphics[width=.42\linewidth]{\detokenize{figuras/visualizacao/geracao-treino-fixed.png}}
      }
    \end{center}
