...
\begin{frame}{Quantização de imagens}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Versões de um canal de cor com 232 intensidades únicas para o método (e) MSB e 184 intensidades para os demais métodos. Os métodos \emph{Luminância'} e MSB apresentam uma melhor discriminação entre cores.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Quantização de imagens}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Imagens da base \emph{Caltech101-600} com variações no parâmetro de cor utilizando o método MSB. Com 256, 128 e 64 há preservação das cores. Com apenas 32, perda considerável de informação nas regiões com pouco contraste.}
  \end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Método}
...
\begin{frame}{Experimentos --- Resultados}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Acurácia média utilizando MSB e BIC considerando 256, 128, 64 e 32 cores. Os \textit{boxplots} em cinza correspondem às significâncias estatísticas com $\textit{p-value} < 0.01$ quando comparado à acurácia de 256 cores.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
...
\begin{frame}{Experimentos --- Resultados}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Acurácia para \emph{Gleam}, \emph{Intensidade'}, \emph{Luminância'} e MSB. O vetor de características resultante com $D=2310$ sofreu então redução da dimensionalidade com o método LPP para $d = 1160$, $582$, $294$ e $150$.}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimentos --- Resultados}
...
\justify
  ...
  \begin{enumerate}
    ...
    \item \textbf{Desbalanceamento}: para o sub-experimento de visualização, cada classe foi dividida em 50\% para treino e 50\% para teste, de maneira aleatória. Após, a classe \emph{Horse} sofreu remoção de 50\% do seu conjunto de treino. Já para a análise estatística, todas as 40 configurações de \textit{folds} com $k=5$ foram realizadas;
  \end{enumerate}
\end{frame}
...
\begin{frame}{Experimento}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Comparação dos novos exemplos de treinamento da geração com SMOTE e no campo visual (em laranja).}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
\begin{frame}{Experimento}
