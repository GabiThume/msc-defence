...
\begin{frame}{Quantização de imagens}
  ...
  \begin{figure}
    ...
    \begin{itemize}
      \item \emph{Luminância'} e MSB (\textit{Most Significant Bits}) apresentam uma melhor discriminação entre cores;
...
\begin{frame}{Experimentos --- Quantização versus LPP}
  ...
  \begin{figure}
    ...
    \begin{itemize}
      \item A quantização não se apresenta pior do que o LPP;
      \item Utilizar 64 cores é indicado como uma boa escolha do parâmetro de quantização.
    \end{itemize}
  \end{figure}
\end{frame}
%-----------------------------------------------------------------------------
...
\begin{frame}{Geração de imagens artificiais --- Mistura saliente}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{Combinação de saliência obtida com GMR (\textit{Graph-Based Manifold Ranking}).}
    \begin{itemize}
